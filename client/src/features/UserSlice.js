...
export const getUser=createAsyncThunk("users/getUser",async(udata)=>{
    try{
        const response=await axios.post("https://carrent-73b7.onrender.com/login",udata);
...
export const addUser=createAsyncThunk("users/addUser",async(udata)=>{
    try{
        const response=await axios.post("https://carrent-73b7.onrender.com/register",udata);
